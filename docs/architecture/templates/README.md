...
- [Cadrage d'une EPIC](epic-cadrage-template.md) : besoin, périmètre, critères d'acceptation et impacts initiaux dans le backlog canonique.
...
Le [cycle d'epic](../../organisation/cycle-epic.md) définit le passage du cadrage aux preuves d'implémentation, la traçabilité et les critères de préparation et de fin. Les états produit restent ceux de la roadmap commune.
