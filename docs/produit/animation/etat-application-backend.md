...
- [Architecture du domaine Animation](../../architecture/backend/epics/epic-41-animation-locale-architecture.md)
...
### Chargement BUM groupé (F10)

Le catalogue lit la politique active une fois par requête et charge les coffrets
et qualifications de la page en deux lectures groupées. Le nombre de lectures BUM
ne croît pas avec le nombre de coffrets de la page. Les motifs de blocage restent
identiques au contrôle unitaire ; aucun cache global ne retarde une requalification.
